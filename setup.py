...
try:
    ...
    long_description = 'Check https://github.com/namratachaudhary/noise for readme.'
...
setup(
    ...
    url='https://github.com/namratachaudhary/noise',
    author='Namrata Chaudhary',
    author_email='chdhry.namrata@gmail.com',
    license='MIT',
    classifiers=[
