...
class HkdfTest(unittest.TestCase):
    ...
    def test_vector(self):
        ...
        actualOutput = Hkdf(salt, ikm, hashlib.sha256).expand(info, 42)
    ...
    def test_vector_2(self):
        ...
        actualOutput = Hkdf(salt, ikm, hashlib.sha256).expand(info, 82)
        self.assertEqual(okm, actualOutput)
    ...
    #     actualOutput = Hkdf(salt, ikm, hashlib.sha256).expand(info, 64)
    #     self.assertEqual(okm, actualOutput)
